...
export default class Game extends Phaser.Scene {
  ...
  private handleCollectCoin(obj1: Phaser.GameObjects.GameObject, obj2: Phaser.GameObjects.GameObject) {
    const coin = obj2 as Phaser.Physics.Arcade.Sprite // obj2 will be the coin
    this.coins.killAndHide(coin) // use the group to hide it
    coin.body.enable = false // and turn off the physics body
    this.score += 1
